...
## @examples
#' @export
add_geojson <- function(map, data, file, style = NULL, ##popup = NULL,
                        options = NULL, data_proj = NULL) {
    ...
    invoke_method(map, "add_geojson", data, style, flat_style, options, data_proj)
}
